...
//creates a horizontal line to the textContent
...
// table.setAttribute("id",tab);
  ...
  for (var i = 0; i < skills.length; i++) {
    row =row+"<tr><td>"+skills[i].name+"</td><td>"+skills[i].value+"</td></tr>";//also written as row =row+"<tr><td>"+skills.name+"</td><td>"+skills.value+"</td></tr>"
}
table.innerHTML=row;
